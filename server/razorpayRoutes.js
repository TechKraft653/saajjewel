...
// Initialize Razorpay with environment variables or default test keys
const razorpay = new Razorpay({
  key_id: process.env.RAZORPAY_KEY_ID || 'rzp_test_RcW2dLNPJC62oO',
  key_secret: process.env.RAZORPAY_KEY_SECRET || 'OPBftAm7dNkaf3t5X3LBrJ0d'
});
